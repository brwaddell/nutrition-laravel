...
<div class="section-wrap-body">
    ...
    <div class="single-section">
        ...
        <ul class="permission-lsit">
            <li>
                <span class="permission-text">./application/routes</span>
            ...
            <li>
                <span class="permission-text">./application/resources</span>
            ...
            <li>
                <span class="permission-text">./application/public</span>
            ...
            <li>
                <span class="permission-text">./application/storage</span>
            ...
            <li>
                <span class="permission-text">./application/.env</span>
