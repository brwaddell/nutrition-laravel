    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">A Message By {{ $vaccine->user->name }}</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Name: {{$vaccine->subject}}</li>
                        <li class="list-group-item">Description: {!! $vaccine->message !!}</li>
                        <li class="list-group-item">Attachment: <a href="{{ asset(path_message_attachment().'/'.$vaccine->attachment) }}">{{$vaccine->attachment}}</a> </li>
